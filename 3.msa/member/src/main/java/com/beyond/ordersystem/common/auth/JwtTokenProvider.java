...
//    Qualifier는 기본적으로 메서드를 통한 주입이 가능, 그래서 이 경우 생성자 주입방식을 해야 Qualifier 사용 가능
...
//        rt 자체 검증
        ...
        Member member = memberRepository.findByEmail(email).orElseThrow(() -> new EntityNotFoundException("계정이 존재하지 않습니다."));
